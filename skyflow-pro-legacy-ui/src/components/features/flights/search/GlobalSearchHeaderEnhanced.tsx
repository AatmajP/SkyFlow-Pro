...
import { Search, ArrowRightLeft, Calendar, Users, Info } from 'lucide-react'
import { useState } from 'react'
import { useNavigate } from 'react-router-dom'
import { FlexDateStrip } from '../calendar/FlexDateStrip'
import { AirportAutocomplete } from '../search/AirportAutocomplete'
import { DestinationSuggester } from '../search/DestinationSuggester'

import { getCabinClassLabel, getAllCabinClasses } from '@/config'
    ...
    return (
        ...
        >
                    ...
                    <div className="relative">
                        ...
                        >
                            {cabinClasses.map((cabinClass) => (
                                <option key={cabinClass} value={cabinClass} className="bg-slate-900">
            ...
            <div className="border-t border-slate-700/50 pt-4 mt-2">
                <DestinationSuggester onSelectCity={(code) => handleChange('to', code)} />
            </div>
        </section>
    )
}
