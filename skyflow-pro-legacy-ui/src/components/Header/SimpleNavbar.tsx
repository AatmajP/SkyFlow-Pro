/**
 * Simple Navbar - Minimal header variant
 */
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button className="relative p-2 rounded-lg text-slate-400 hover:text-slate-50 hover:bg-slate-800/50 transition-all duration-300" aria-label="Notifications">
                            <Bell className="h-5 w-5" />
                            <span className="absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-sky-500 animate-pulse" />
                        </button>
                        <button className="p-2 rounded-lg text-slate-400 hover:text-slate-50 hover:bg-slate-800/50 transition-all duration-300" aria-label="Settings">
