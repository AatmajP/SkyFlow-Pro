        ...
        <div ref={wrapperRef} className="relative">
            ...
            {isOpen && suggestions.length > 0 && (
                <div
                    ...
                    role="listbox"
                    className="absolute z-50 mt-2 w-full rounded-2xl bg-white border border-slate-200 shadow-2xl max-h-80 overflow-y-auto animate-fade-in"
                >
                    {suggestions.map((airport, index) => (
                        <button
                            ...
                            className={`w-full text-left px-5 py-4 border-b border-slate-50 last:border-b-0 transition-all duration-200 ${index === selectedIndex
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center justify-between gap-2">
                                        ...
                                        <span className="text-[10px] font-black tracking-widest text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded uppercase">{airport.code}</span>
                                    </div>
