# SkyFlow Pro (Frontend)

Truth-first flight booking UX prototype (Vite + React + TypeScript + Tailwind).

## Run locally

From the `skyflow-pro` folder:
...
- `/results`: Results page driven by URL query params
