...
const AIRPORTS: AirportInfo[] = [
  // India — Metro
  { code: 'DEL', city: 'New Delhi', country: 'India', tags: ['city', 'capital', 'history'] },
  { code: 'BOM', city: 'Mumbai', country: 'India', tags: ['city', 'business', 'beach'] },
  { code: 'BLR', city: 'Bengaluru', country: 'India', tags: ['city', 'tech', 'garden'] },
  { code: 'HYD', city: 'Hyderabad', country: 'India', tags: ['city', 'tech', 'history'] },
  { code: 'MAA', city: 'Chennai', country: 'India', tags: ['city', 'beach', 'temple'] },
  { code: 'CCU', city: 'Kolkata', country: 'India', tags: ['city', 'culture', 'heritage'] },
  { code: 'AMD', city: 'Ahmedabad', country: 'India', tags: ['city', 'heritage', 'food'] },
  { code: 'PNQ', city: 'Pune', country: 'India', tags: ['city', 'tech', 'education'] },
  { code: 'GOI', city: 'Goa', country: 'India', tags: ['beach', 'party', 'nature'] },
  { code: 'JAI', city: 'Jaipur', country: 'India', tags: ['heritage', 'palace', 'desert'] },
  { code: 'LKO', city: 'Lucknow', country: 'India', tags: ['heritage', 'food', 'culture'] },
  { code: 'COK', city: 'Kochi', country: 'India', tags: ['beach', 'backwater', 'spice'] },
  { code: 'TRV', city: 'Thiruvananthapuram', country: 'India', tags: ['beach', 'temple', 'nature'] },
  // India — Tier-2
  { code: 'VNS', city: 'Varanasi', country: 'India', tags: ['temple', 'spiritual', 'history'] },
  { code: 'IXC', city: 'Chandigarh', country: 'India', tags: ['city', 'garden', 'mountain'] },
  { code: 'GAU', city: 'Guwahati', country: 'India', tags: ['nature', 'temple', 'northeast'] },
  { code: 'PAT', city: 'Patna', country: 'India', tags: ['history', 'culture', 'river'] },
  { code: 'BBI', city: 'Bhubaneswar', country: 'India', tags: ['temple', 'culture', 'history'] },
  { code: 'IXB', city: 'Bagdogra', country: 'India', tags: ['mountain', 'tea', 'darjeeling'] },
  { code: 'SXR', city: 'Srinagar', country: 'India', tags: ['mountain', 'lake', 'valley'] },
  { code: 'VTZ', city: 'Visakhapatnam', country: 'India', tags: ['beach', 'port', 'nature'] },
  { code: 'IDR', city: 'Indore', country: 'India', tags: ['food', 'heritage', 'city'] },
  { code: 'NAG', city: 'Nagpur', country: 'India', tags: ['city', 'nature', 'central'] },
  { code: 'UDR', city: 'Udaipur', country: 'India', tags: ['heritage', 'lake', 'romantic'] },
  { code: 'JDH', city: 'Jodhpur', country: 'India', tags: ['heritage', 'desert', 'fort'] },
  { code: 'DED', city: 'Dehradun', country: 'India', tags: ['mountain', 'nature', 'adventure'] },
  { code: 'IXZ', city: 'Port Blair', country: 'India', tags: ['beach', 'island', 'scuba'] },
  { code: 'ATQ', city: 'Amritsar', country: 'India', tags: ['temple', 'spiritual', 'food'] },
  { code: 'TIR', city: 'Tirupati', country: 'India', tags: ['temple', 'spiritual', 'pilgrimage'] },
  { code: 'RPR', city: 'Raipur', country: 'India', tags: ['nature', 'waterfall', 'city'] },
  { code: 'IXR', city: 'Ranchi', country: 'India', tags: ['nature', 'waterfall', 'tribal'] },
  // International
  { code: 'DXB', city: 'Dubai', country: 'UAE', tags: ['luxury', 'shopping', 'desert'] },
  { code: 'SIN', city: 'Singapore', country: 'Singapore', tags: ['city', 'garden', 'food'] },
  { code: 'BKK', city: 'Bangkok', country: 'Thailand', tags: ['temple', 'streetfood', 'nightlife'] },
  { code: 'LHR', city: 'London', country: 'UK', tags: ['city', 'history', 'culture'] },
  { code: 'JFK', city: 'New York', country: 'USA', tags: ['city', 'business', 'shopping'] },
  { code: 'LAX', city: 'Los Angeles', country: 'USA', tags: ['beach', 'entertainment', 'city'] },
  { code: 'SFO', city: 'San Francisco', country: 'USA', tags: ['tech', 'city', 'bridge'] },
  { code: 'NRT', city: 'Tokyo', country: 'Japan', tags: ['city', 'culture', 'tech'] },
  { code: 'CDG', city: 'Paris', country: 'France', tags: ['city', 'culture', 'fashion'] },
  { code: 'FRA', city: 'Frankfurt', country: 'Germany', tags: ['city', 'business', 'culture'] },
  { code: 'SYD', city: 'Sydney', country: 'Australia', tags: ['beach', 'harbor', 'city'] },
  { code: 'DOH', city: 'Doha', country: 'Qatar', tags: ['luxury', 'museum', 'desert'] },
  { code: 'KUL', city: 'Kuala Lumpur', country: 'Malaysia', tags: ['city', 'shopping', 'food'] },
  { code: 'HKG', city: 'Hong Kong', country: 'China', tags: ['city', 'shopping', 'skyline'] },
  { code: 'MIA', city: 'Miami', country: 'USA', tags: ['beach', 'nightlife', 'cruise'] },
  { code: 'YYZ', city: 'Toronto', country: 'Canada', tags: ['city', 'culture', 'nature'] },
  { code: 'ZRH', city: 'Zurich', country: 'Switzerland', tags: ['mountain', 'chocolate', 'lake'] },
