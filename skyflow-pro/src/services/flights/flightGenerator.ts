...
import type { FlightOption, FlightSegment, CabinClass } from '@/types'
import { AIRLINES } from '@/config'
import { calculateCabinPrice } from '@/config'
 ...
 */
function calculateFlightDuration(_from: string, _to: string): number {
