    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in">
      ...
      <div className="glass rounded-2xl p-6 border border-slate-800/50 flex flex-col gap-4 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-slate-100">{t('results.insights.fareTitle')}</h3>
        </div>
      ...
      <div className="glass rounded-2xl p-6 border border-slate-800/50 flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-slate-100">{t('results.insights.demandTitle')}</h3>
        </div>

        <div className="space-y-5">
          <div>
            <div className="flex justify-between items-end mb-2">
              <span className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">{t('results.insights.occupancy')}</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50">
              <p className="text-[10px] text-slate-500 uppercase font-black tracking-tighter">{t('results.insights.popularity')}</p>
            ...
            <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50">
              <p className="text-[10px] text-slate-500 uppercase font-black tracking-tighter">{t('results.insights.trend')}</p>
      ...
      <div className="glass rounded-2xl p-6 border border-slate-800/50 flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-slate-100">{t('results.insights.optimizationTitle')}</h3>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="mt-2 flex items-center gap-2 p-3 rounded-xl bg-sky-50 dark:bg-sky-500/5 border border-sky-100 dark:border-sky-500/10">
            ...
            <p className="text-[11px] text-sky-700 dark:text-sky-300 font-bold">{t('results.insights.onTime')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-6 border border-slate-800/50 flex flex-col gap-4 md:col-span-2 lg:col-span-1">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-bold text-slate-900 dark:text-slate-100">{t('results.insights.upgradeTitle')}</h3>
        </div>

        <div className="flex-1 flex flex-col justify-between gap-4">
          <div className="space-y-3">
            <p className="text-sm font-bold text-slate-900 dark:text-slate-200">{t('results.insights.worthUpgrade')}</p>
