...
import { useNotifications, type FlightNotification, syncWithBookings } from '@/stores'
import { useBookingStore } from '@/stores' // Import useBookingStore
...
type NotificationType = FlightNotification['type']
...
const PRIORITY_COLORS: Record<FlightNotification['priority'], string> = {
